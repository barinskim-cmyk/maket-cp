...
-- VACUUM нельзя внутри транзакции, сделаем после
COMMIT;

-- Освобождаем место (reclaim bloat страниц таблицы и индексов).
-- ANALYZE обновляет статистику планировщика после массового удаления.
