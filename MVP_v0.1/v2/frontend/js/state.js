...
/**
 * Предустановленные категории. Проект может дополнять этот список
 * через proj.categories (пользовательские категории).
 * @type {Object<string, string>}
 */
var CAT_NAMES = {
  shoes: 'Обувь', bag: 'Сумка', glasses: 'Очки', accessory: 'Аксессуар'
};
