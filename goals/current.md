...
**Период:** 2026-04-28 – 2026-05-11 (2 недели)
...
**Один абзац для Маши:** цикл 1 — это не продажи и не релиз. Это «вставили ключи в замки»: юристу дали скоуп и ответы на вопросы (или default'ы), Беларуси сделали one-pager и ждём твоего бренда/канала, продукту починили последнюю архитектурную дыру (photo_versions), лендингу убрали всё устаревшее, кандидату A отдали [anchor client] pack как задачу. К 11 мая у команды есть материал, на котором цикл 2 уже закрывает деньги.
...
## Проверка через 2 недели (5-11 мая)
...
| M6 | Подтверждение бюджета 30-50к ₽ на live-lawyer + источник | 2026-05-11 (вс W2) | live-lawyer встреча (cycle 3) |
| M7 | Goal card cycle 1 — подпись | до старта W1 (2026-04-28) | запуск цикла |
